 ...
 * In diesem Fall wird der author aus den Blockkommentaren entfernt.
 * 
 * @author Dominik Kodras
 * @version 22.04.2016
 */
public class AuthorEntfernen extends Decorator {
	MyFile file;
	
	public AuthorEntfernen(MyFile file) {
		this.file = file;
	}
	
	@Override
	public String getFileType() {
		return file.getFileType() + ", Author entfernen";
	}
...
//			scanner.close();
		...
		fileContent = fileContent.replaceAll("\\s*\\*+\\s*(@author){1}(\\s+\\w+)+", "");
